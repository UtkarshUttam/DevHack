...
"border-radius:40px;")
        ...
        mycursor.execute("SELECT name FROM hackathons_data1 WHERE hack_id = 1;")
...
"}")
        ...
        mycursor.execute("SELECT name FROM hackathons_data1 WHERE hack_id = 2;")
...
"}")
        ...
        mycursor.execute("SELECT name FROM hackathons_data1 WHERE hack_id = 3;")
