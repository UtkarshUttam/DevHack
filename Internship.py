...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1231, 1430))
...
"color: rgb(255, 255, 255);")
        ...
        self.pushButton.setStyleSheet("image: url(:/images/media/How-do-hackathons-work.png);")
...
"border-radius:50px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox.setItemText(0, _translate("MainWindow", "option 1"))
        self.comboBox.setItemText(1, _translate("MainWindow", "option 2"))
        self.comboBox.setItemText(2, _translate("MainWindow", "option 3"))
        self.comboBox_2.setPlaceholderText(_translate("MainWindow", "Date"))
        self.comboBox_3.setPlaceholderText(_translate("MainWindow", "Price"))
        self.comboBox_4.setPlaceholderText(_translate("MainWindow", "Format"))
        self.label.setText(_translate("MainWindow", "Internship Name"))
        self.label_3.setText(_translate("MainWindow", "Starting date and Ending Date"))
        self.label_4.setText(_translate("MainWindow", "Stipend: 5000/-"))
